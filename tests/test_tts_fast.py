...
from oarc.utils.const import HF_VOICE_REF_PACK_C3PO
...
def test_basic_tts():
    ...
    try:
        ...
        sample_text = "Hello! I am C-3PO, human-cyborg relations! Is this Borch? I miss my friend Borch? Have you seen borch, o dear I hope something had not happened to him?"
